...
ifeq ($(config),release_x64)
  RESCOMP = windres
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/test_all.exe
  OBJDIR = ../obj/x64/Release/test_all
  DEFINES += -DNDEBUG
...
ifeq ($(config),release_x86)
  ...
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/test_all.exe
  OBJDIR = ../obj/x86/Release/test_all
  DEFINES += -DNDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x64)
  RESCOMP = windres
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/test_all_d.exe
  OBJDIR = ../obj/x64/Debug/test_all
  DEFINES += -DDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/test_all.o: ../../test/test_all.c
	@echo $(notdir $<)
